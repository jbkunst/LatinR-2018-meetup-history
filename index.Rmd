...
p <- ggplot() +
  geom_line(data = members, aes(as.Date(joined2), nacum), size = 2, color = "#543FFF") +
  geom_vline(data = events, aes(xintercept = as.Date(time), color = as.numeric(time)), size  = 2, alpha = 0.3) +
