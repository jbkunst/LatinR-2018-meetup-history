...
## 1ra reunión - 6 Personas <br> `r date_event(2)` { .right .white data-background="static/imgs/highres_235491512.jpeg"} 
...
## Mensaje #2: { .left .center .white data-background="https://i.ytimg.com/vi/6AnAhdN9nDg/maxresdefault.jpg"} 
...
ggplot() +
  geom_line(data = members, aes(joined, nacum)) +
